    ...
    <section id="home" data-section className="hero section-dark">
      <div className="hero-grid blueprint">
        <div className="hero-copy">
          ...
          <motion.p className="hero-role" {...enter(0.34)}>Full Stack Developer</motion.p>
          ...
          <motion.div className="hero-actions" {...enter(0.52)}>
            ...
            <a className="text-link" href={siteConfig.github} target="_blank" rel="noopener noreferrer" aria-label="View Syed Mughees Ali on GitHub (opens in a new tab)"><GitHubIcon size={17}/> GitHub</a>
          </motion.div>
        ...
        <motion.div className="portrait-stage" initial={reduced ? false : { opacity: 0, clipPath: "inset(0 0 100% 0)" }} animate={{ opacity: 1, clipPath: "inset(0 0 0% 0)" }} transition={{ delay: 0.38, duration: 0.72, ease: [0.22, 1, 0.36, 1] }}>
          ...
          >
            {isPublicAssetUrl(siteConfig.portrait) ? <Image src={siteConfig.portrait} alt="Portrait of Syed Mughees Ali" width={1000} height={1000} sizes="(max-width: 580px) 90vw, (max-width: 900px) 70vw, 40vw" priority/> : <div className="portrait-placeholder" role="img" aria-label="Portrait pending"><span>SMA</span><small>Professional portrait pending</small></div>}
